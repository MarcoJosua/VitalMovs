    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(
                ...
                (auth) -> auth
                        ...
                        .requestMatchers(HttpMethod.POST,"/vitalmovs/fisioterapeuta").permitAll()
                        .requestMatchers(HttpMethod.PUT,"/vitalmovs/fisioterapeuta").hasAnyAuthority("ROLE_ADMIN","ROLE_FISIOTERAPEUTA")
                        ...
                        .requestMatchers(HttpMethod.GET,"/vitalmovs/fisioterapeutaDiscapacidad/fisioterapeuta/{fisioterapeutaId}").permitAll()
                        .requestMatchers(HttpMethod.POST,"/vitalmovs/fisioterapeutaDiscapacidad").permitAll()
                        ...
                        .requestMatchers(HttpMethod.POST,"/vitalmovs/paciente").permitAll()
                        ...
                        .requestMatchers(HttpMethod.GET,"/vitalmovs/tipoDiscapacidad/tipos").permitAll()
                        ...
                        .requestMatchers(HttpMethod.GET,"/vitalmovs/pacienteDiscapacidad/paciente/**").permitAll()
                        .requestMatchers(HttpMethod.POST,"/vitalmovs/pacienteDiscapacidad").permitAll()
                        ...
                        .requestMatchers(HttpMethod.GET, "/vitalmovs/asignaciones/fisioterapeuta/{userId}").hasAnyAuthority("ROLE_FISIOTERAPEUTA")
                        .requestMatchers(HttpMethod.GET, "/vitalmovs/asignaciones/paciente/{userId}").hasAnyAuthority("ROLE_PACIENTE")
                        ...
                        .requestMatchers(HttpMethod.PUT, "/vitalmovs/planes").hasAnyAuthority("ROLE_FISIOTERAPEUTA","ROLE_PACIENTE")
